...
1. Meausure the volume of the lysate from the previous step in a measuring cylinder and dilute if necessary (_e.g._ if the solution is very dark/viscous).
